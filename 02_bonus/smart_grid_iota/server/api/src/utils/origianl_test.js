...
const transfer = require("../../libs/flash_channels/lib/transfer")
const multisig = require("../../libs/flash_channels/lib/multisig")
...
let oneMultisigs = oneFlash.partialDigests.map((digest, index) => {
  // Create address
  console.log('all digest :', allDigests);
